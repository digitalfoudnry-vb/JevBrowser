# Fork 0.1.0 — 2026-09-20

Reusable Hermes/browser skill, Vercel integration documentation, guarded public
browser egress, safer field entry, shared validation, dependency updates and
security regression tests. See docs/security-review.md.

The entries below describe the original upstream project.
